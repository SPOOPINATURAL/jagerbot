...
class AlertCommands(commands.Cog):
    ...
    @bridge.bridge_command(name="alert", description="Set an alert via interactive modal")
    ...
    @bridge.bridge_command(name="listalerts", description="List your active alerts with controls")
    ...
    @bridge.bridge_command(name="cancelalerts", description="Cancel all your active alerts")
